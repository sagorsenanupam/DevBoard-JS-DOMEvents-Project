...
function acitivtyLog(id) {
  ...
  <p class='mb-1 rounded-lg p-2 bg-[#F4F7FF] justify-center items-center text-center text-sm'>You have completed the task ${title} at <span style="color:green;">${time}</span> on ${date}</p>
`;
}
